...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Activities
        activities = [
            Activity(user='ironman@marvel.com', activity_type='run', duration=30),
            Activity(user='captain@marvel.com', activity_type='cycle', duration=45),
            Activity(user='batman@dc.com', activity_type='swim', duration=25),
            Activity(user='wonderwoman@dc.com', activity_type='yoga', duration=60),
        ]
